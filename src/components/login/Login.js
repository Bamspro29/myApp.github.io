      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-sm">
        <div className="flex justify-center mb-10">
          <img
            src={SVG}
            alt="Symbol"
            className="mr-2 mt-5 text-center text-2xl font-bold leading-9 tracking-tight text-white"
          />
          <h2 className="ml-3 mt-5 text-center text-2xl font-bold leading-9 tracking-tight text-white">
            RED PRODUCT
          </h2>
        </div>
      </div>

      <div className="conexpages">
        ...
        <div className="flex items-center justify-between">
          <div className="text-sm">
            <Link to="/Mdpf" className="font-semibold leading-6 text-indigo-600 hover:bg-white">
              Mot de passe oublié ?
            </Link>
          </div>
        </div>
        <p className="text-center text-sm text-gray-500">
          ...
          <Link to="/inscription" className="font-semibold leading-6 text-indigo-600 hover:bg-white">
            S'inscrire
          </Link>
        </p>
      </div>
